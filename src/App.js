...
const exchange = exchangeABI.at('0xbec3a6e7b53e5f3bc994021d76855c11944155a6')

const test = testABI.at('0x8e254816db29a274955be976a8115eb38897edfb')

const exchangeAddress = '0xbec3a6e7b53e5f3bc994021d76855c11944155a6'
...
class App extends Component {
  ...
  sendTradeOrder(e) {
    ...
    exchange.balanceOf("0x7da4ec2c0e73b0ece234213d72fb317792d7d200", "0xc14791EF2A9bc70ab41d6b9ad245077b07C773De", (error, result) => {
      if (!error)
        console.log(result);
    })
